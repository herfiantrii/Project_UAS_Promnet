...
<body>
  <div class="signup-form">
    <form action="" method="POST" autocomplete="off">
      ...
      <div class="form-group">
        <label class="form-check-label"><input type="checkbox" required="required"> Saya menyetujui <a href="#">Syarat Penggunaan</a> &amp; <a href="#">Kebijakan Privasi</a></label>
      </div>
      <div class="form-group">
        <button type="submit" class="btn btn-danger btn-lg btn-block" style="border-radius:0%;">Register</button>
      </div>
    </form>
    <div class="text-center">Already have an account? <a class="text-success" href="login.php">Login di sini</a></div>
  </div>
</body>
