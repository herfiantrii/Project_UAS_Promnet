  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h3 class="mt-4">Money-Balance Website</h3>
        <div class="row">
          <div class="col-md">
            <div class="card">
              <div class="card-body">
        ...
        <h3 class="mt-4">Histori Pengeluaran Keseluruhan</h3>
        <div class="row">
          <div class="col-md">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title text-center">Grafik Pengeluaran Harian</h5>
              </div>
              <div class="card-body">
          ...
          <div class="col-md">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title text-center">Grafik Kategori Pengeluaran</h5>
              </div>
              <div class="card-body">
