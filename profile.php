        ...
        <div id="page-content-wrapper">
                    ...
                    <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="profile.php">Profil Anda</a>
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-md-6">
                    <h3 class="mt-4 text-center">Perbarui Profile</h3>
                    <hr>
                        <form class="form" method="post" action="" enctype='multipart/form-data'>
                            ...
                            <div class="input-group col-md mb-3 mt-3">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="profilepic">Ubah Foto</label>
                                </div>
                                <div class="input-group-append">
                                    <button class="btn btn-secondary" type="submit" name='but_upload' id="profilepicinput">Unggah Foto</button>
                                </div>
                            </div>
                        ...
                        <form class="form" action="" method="post" id="registrationForm" autocomplete="off">
                            ...
                            <div class="form-group">
                                <div class="col-md">
                                    <br>
                                    <button class="btn btn-block btn-md btn-success" style="border-radius:0%;" name="save" type="submit">Simpan Perubahan</button>
                                </div>
                            </div>
                        </form>
                        <!--/tab-content-->
